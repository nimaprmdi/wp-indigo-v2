...
function wp_indigo_scripts() {
	wp_enqueue_style( 'wp-indigo-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'wp-indigo-style', 'rtl', 'replace' );

	wp_enqueue_script( 'wp-indigo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
